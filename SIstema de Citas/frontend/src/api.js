...
export const api = {
  ...
  users: {
    ...
    createAdminUser: (payload, token) => apiRequest(USERS_API, "/admin/users", "POST", payload, token),
    deleteAdminUser: (id, token) => apiRequest(USERS_API, `/admin/users/${id}`, "DELETE", null, token),
  },
  appointments: {
    ...
    updateService: (id, payload, token) => apiRequest(APPOINTMENTS_API, `/services/${id}`, "PATCH", payload, token),
    deleteService: (id, token) => apiRequest(APPOINTMENTS_API, `/services/${id}`, "DELETE", null, token),
    getAvailability: (providerId) => apiRequest(APPOINTMENTS_API, `/availability/${providerId}`),
